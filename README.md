...
* Check [info.py](https://github.com/kckhais/KC-Films-Bot/blob/master/info.py) for more


<details><summary>Deploy To Heroku</summary>
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/kckhais/KC-Films-Bot">
